  ...
  blaze: {
    ...
    cgEvents: [
      ...
      },
      {
        ...
        cgColor: '#e85d3a',
        dialogue: [
          { speaker: 'ブレイズ', text: '……ねぇ、疲れたでしょ。ほら、ここ……おいで。' },
          { speaker: 'ブレイズ', text: '（ブレイズがドクターの頭をそっと自分の太ももに導く）' },
          { speaker: 'ドクター', text: '……え？' },
          { speaker: 'ブレイズ', text: 'いいから……じっとしてて。……ん、髪、さらさらじゃん……' },
          { speaker: 'ブレイズ', text: 'あったかいでしょ、あたしの太もも……ふふ、耳まで赤いよ、ドクター' },
          { speaker: 'ブレイズ', text: '……このまま寝ちゃいなよ。……起こさないであげるから……ね？' }
        ]
      },
      {
        id: 'blaze_kiss',
