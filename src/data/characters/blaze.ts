  ...
  cgEvents: [
    {
      ...
      frames: [{ src: '/characters/blaze/cg/shoulder_lean.webp', label: '耳元でささやく', dialogueStart: 0, transition: 'fade' }],
    },
    {
      ...
      frames: [{ src: '/characters/blaze/cg/headpat.webp', label: 'うなじを撫でる', dialogueStart: 0, transition: 'fade' }],
    },
    {
      ...
      frames: [
        { src: '/characters/blaze/cg/breast_touch_1.webp', label: '手が伸びる', dialogueStart: 0, transition: 'fade' },
        { src: '/characters/blaze/cg/breast_touch_2.webp', label: '胸に触れる', dialogueStart: 1, transition: 'zoom' },
        { src: '/characters/blaze/cg/breast_touch_3.webp', label: '感じてる表情', dialogueStart: 3, transition: 'fade' },
      ],
    },
    {
      ...
      frames: [{ src: '/characters/blaze/cg/hip_touch.webp', label: 'お尻をなでる', dialogueStart: 0, transition: 'fade' }],
    },
    {
      ...
      frames: [
        { src: '/characters/blaze/cg/ear_bite_1.webp', label: '耳に顔を近づける', dialogueStart: 0, transition: 'slide-left' },
        { src: '/characters/blaze/cg/ear_bite_2.webp', label: '耳たぶを噛む', dialogueStart: 1, transition: 'zoom' },
        { src: '/characters/blaze/cg/ear_bite_3.webp', label: '蕩けた表情', dialogueStart: 3, transition: 'fade' },
      ],
    },
    {
      ...
      frames: [{ src: '/characters/blaze/cg/lap_pillow.webp', label: '太ももに誘う', dialogueStart: 0, transition: 'fade' }],
    },
    {
      ...
      frames: [
        { src: '/characters/blaze/cg/kiss_1.webp', label: '腰を引き寄せる', dialogueStart: 0, transition: 'fade' },
        { src: '/characters/blaze/cg/kiss_2.webp', label: '唇が近づく', dialogueStart: 2, transition: 'zoom' },
        { src: '/characters/blaze/cg/kiss_3.webp', label: 'キス', dialogueStart: 3, transition: 'fade' },
        { src: '/characters/blaze/cg/kiss_4.webp', label: '余韻', dialogueStart: 4, transition: 'fade' },
      ],
    },
    // 逆セクハラCG
    {
      ...
      frames: [
        { src: '/characters/blaze/cg/foot_tease_1.webp', label: 'テーブル下の気配', dialogueStart: 0, transition: 'fade' },
        { src: '/characters/blaze/cg/foot_tease_2.webp', label: '挑発する笑み', dialogueStart: 2, transition: 'zoom' },
        { src: '/characters/blaze/cg/foot_tease_3.webp', label: '攻めるブレイズ', dialogueStart: 3, transition: 'fade' },
      ],
    },
    {
      ...
      frames: [
        { src: '/characters/blaze/cg/dirty_talk_1.webp', label: '耳元に近づく', dialogueStart: 0, transition: 'slide-left' },
        { src: '/characters/blaze/cg/dirty_talk_2.webp', label: '囁く表情', dialogueStart: 2, transition: 'zoom' },
        { src: '/characters/blaze/cg/dirty_talk_3.webp', label: '満足げな笑み', dialogueStart: 4, transition: 'fade' },
      ],
    }
  ],
  afterEvents: [
    {
      id: 'blaze_after_tipsy', requiredCGRate: 0.25, requiredWins: 1,
      title: 'ほろ酔いお持ち帰り', cgColor: '#e85d3a', emoji: '🌙',
      dialogue: [
    ...
    {
      id: 'blaze_after_drunk', requiredCGRate: 0.5, requiredWins: 3,
      title: 'ドクターの部屋で', cgColor: '#ff6b8a', emoji: '🛏️',
      dialogue: [
    ...
    {
      id: 'blaze_after_morning', requiredCGRate: 0.75, requiredWins: 5,
      title: '翌朝', cgColor: '#ffaa66', emoji: '🌅',
      dialogue: [
    ...
    {
      id: 'blaze_after_complete', requiredCGRate: 1.0, requiredWins: 8,
      title: '今夜は帰さない', cgColor: '#ff3355', emoji: '💕',
      dialogue: [
